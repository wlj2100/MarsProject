...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "marsproject" because\n';
  ...
  $wnd.__gwt_activeModules['marsproject'] = {
    'moduleName' : 'marsproject',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/marsproject.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['marsproject'].superdevmode = true;

  var expectedSuffix = '/marsproject.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + marsproject + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:marsproject';
  var devModeSessionKey = '__gwtDevModeSession:marsproject';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/marsproject/marsproject.nocache.js';
  ...
  $wnd.__gwt_activeModules['marsproject'].canRedirect = true;
  $wnd.__gwt_activeModules['marsproject'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/marsproject?user.agent=' + ua + '&_callback=' + callback;
